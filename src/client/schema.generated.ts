...
export interface CreateProjectTypeInput {
  /** The slug that the projecttype will be an alias of */
  aliasOf?: InputMaybe<Scalars["String"]>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
  /** The description of the projecttype object */
  description?: InputMaybe<Scalars["String"]>;
  /** The name of the projecttype object to mutate */
  name: Scalars["String"];
  /** If this argument exists then the slug will be checked to see if it is not an existing valid term. If that check succeeds (it is not a valid term), then it is added and the term id is given. If it fails, then a check is made to whether the taxonomy is hierarchical and the parent argument is not empty. If the second check succeeds, the term will be inserted and the term id will be given. If the slug argument is empty, then it will be calculated from the term name. */
  slug?: InputMaybe<Scalars["String"]>;
}
...
export interface DeleteProjectTypeInput {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
...
export interface ProjectProjectTypesInput {
...
export interface ProjectProjectTypesNodeInput {
...
export interface ProjectToProjectTypeConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars["Int"]>;
...
export interface ProjectToTermNodeConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars["Int"]>;
...
export interface ProjectTypeToContentNodeConnectionWhereArgs {
  /** The Types of content to filter */
...
export interface ProjectTypeToProjectConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
export interface RootQueryToPersonConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
export interface RootQueryToProjectTypeConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars["Int"]>;
...
/** Arguments for filtering the UserToPersonConnection connection */
export interface UserToPersonConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
export const scalarsEnumsHash: import("gqty").ScalarsEnumsHash = {
  ...
  ContentTypesOfProjectTypeEnum: true,
...
export const generatedSchema = {
  ...
  CreateProjectInput: {
    ...
    menuOrder: { __type: "Int" },
    password: { __type: "String" },
    projectTypes: { __type: "ProjectProjectTypesInput" },
    slug: { __type: "String" },
    status: { __type: "PostStatusEnum" },
    title: { __type: "String" },
  },
  ...
  CreateProjectTypePayload: {
    __typename: { __type: "String!" },
    clientMutationId: { __type: "String" },
    projectType: { __type: "ProjectType" },
  },
  CreateTagInput: {
    aliasOf: { __type: "String" },
    clientMutationId: { __type: "String" },
  ...
  Person: {
    ...
    modifiedGmt: { __type: "String" },
    personId: { __type: "Int!" },
    preview: { __type: "PersonToPreviewConnectionEdge" },
    previewRevisionDatabaseId: { __type: "Int" },
    previewRevisionId: { __type: "ID" },
    slug: { __type: "String" },
    status: { __type: "String" },
  ...
  Project: {
    ...
    projectTypes: {
      __type: "ProjectToProjectTypeConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "ProjectToProjectTypeConnectionWhereArgs",
      },
    },
    slug: { __type: "String" },
    status: { __type: "String" },
    ...
    templates: { __type: "[String]" },
    terms: {
      __type: "ProjectToTermNodeConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "ProjectToTermNodeConnectionWhereArgs",
      },
    },
    title: {
      __type: "String",
  ...
  ProjectProjectTypesInput: {
    append: { __type: "Boolean" },
    nodes: { __type: "[ProjectProjectTypesNodeInput]" },
  },
  ProjectProjectTypesNodeInput: {
    description: { __type: "String" },
    id: { __type: "ID" },
    name: { __type: "String" },
    slug: { __type: "String" },
  ...
  ProjectToProjectTypeConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[ProjectToProjectTypeConnectionEdge]" },
    nodes: { __type: "[ProjectType]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  ProjectToProjectTypeConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "ProjectType" },
  },
  ProjectToProjectTypeConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  ProjectToTermNodeConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[ProjectToTermNodeConnectionEdge]" },
    nodes: { __type: "[TermNode]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  ProjectToTermNodeConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "TermNode" },
  },
  ProjectToTermNodeConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  ProjectType: {
    ...
    conditionalTags: { __type: "ConditionalTags" },
    contentNodes: {
      __type: "ProjectTypeToContentNodeConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "ProjectTypeToContentNodeConnectionWhereArgs",
      },
    },
    count: { __type: "Int" },
    databaseId: { __type: "Int!" },
    ...
    link: { __type: "String" },
    name: { __type: "String" },
    projectTypeId: { __type: "Int" },
    projects: {
      __type: "ProjectTypeToProjectConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "ProjectTypeToProjectConnectionWhereArgs",
      },
    },
    slug: { __type: "String" },
    taxonomy: { __type: "ProjectTypeToTaxonomyConnectionEdge" },
    taxonomyName: { __type: "String" },
    templates: { __type: "[String]" },
    termGroupId: { __type: "Int" },
    termTaxonomyId: { __type: "Int" },
  ...
  ProjectTypeToContentNodeConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[ProjectTypeToContentNodeConnectionEdge]" },
    nodes: { __type: "[ContentNode]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  ProjectTypeToContentNodeConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "ContentNode" },
  },
  ProjectTypeToContentNodeConnectionWhereArgs: {
    contentTypes: { __type: "[ContentTypesOfProjectTypeEnum]" },
    dateQuery: { __type: "DateQueryInput" },
    hasPassword: { __type: "Boolean" },
    id: { __type: "Int" },
    in: { __type: "[ID]" },
  ...
  ProjectTypeToProjectConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[ProjectTypeToProjectConnectionEdge]" },
    nodes: { __type: "[Project]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  ProjectTypeToProjectConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Project" },
  },
  ProjectTypeToProjectConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  ProjectTypeToTaxonomyConnectionEdge: {
    __typename: { __type: "String!" },
    node: { __type: "Taxonomy" },
  },
  ReadingSettings: {
  ...
  RootQueryToPersonConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RootQueryToPersonConnectionEdge]" },
    nodes: { __type: "[Person]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  ...
  RootQueryToPersonConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  RootQueryToProjectTypeConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RootQueryToProjectTypeConnectionEdge]" },
    nodes: { __type: "[ProjectType]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  ...
  RootQueryToProjectTypeConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  User: {
    ...
    people: {
      __type: "UserToPersonConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "UserToPersonConnectionWhereArgs",
      },
    },
    posts: {
  ...
  UserToPersonConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[UserToPersonConnectionEdge]" },
    nodes: { __type: "[Person]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  UserToPersonConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Person" },
  },
  UserToPersonConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  mutation: {
    ...
    createPerson: {
      __type: "CreatePersonPayload",
      __args: { input: "CreatePersonInput!" },
    },
    createPost: {
    ...
    createProjectType: {
      __type: "CreateProjectTypePayload",
      __args: { input: "CreateProjectTypeInput!" },
    },
    createTag: {
    ...
    deletePerson: {
      __type: "DeletePersonPayload",
      __args: { input: "DeletePersonInput!" },
    },
    deletePost: {
    ...
    deleteProjectType: {
      __type: "DeleteProjectTypePayload",
      __args: { input: "DeleteProjectTypeInput!" },
    },
    deleteTag: {
    ...
    updatePerson: {
      __type: "UpdatePersonPayload",
      __args: { input: "UpdatePersonInput!" },
    },
    updatePost: {
    ...
    updateProjectType: {
      __type: "UpdateProjectTypePayload",
      __args: { input: "UpdateProjectTypeInput!" },
    },
    updateSettings: {
  ...
  query: {
    ...
    people: {
      __type: "RootQueryToPersonConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
    ...
    person: {
      __type: "Person",
      __args: { asPreview: "Boolean", id: "ID!", idType: "PersonIdType" },
    },
    personBy: {
      __type: "Person",
      __args: { id: "ID", personId: "Int", slug: "String", uri: "String" },
    },
    ...
    projectType: {
      __type: "ProjectType",
      __args: { id: "ID!", idType: "ProjectTypeIdType" },
    },
    projectTypes: {
      __type: "RootQueryToProjectTypeConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "RootQueryToProjectTypeConnectionWhereArgs",
      },
    },
    projects: {
  ...
  [SchemaUnionsKey]: {
    ...
    MenuItemLinkable: ["Category", "Page", "Post", "ProjectType", "Tag"],
    Node: [
      "Category",
      "Comment",
      "CommentAuthor",
    ...
    TermNode: ["Category", "PostFormat", "ProjectType", "Tag"],
    UniformResourceIdentifiable: [
      "Category",
      "ContentType",
      "MediaItem",
    ...
    ContentNode: ["MediaItem", "Page", "Person", "Post", "Project"],
    HierarchicalContentNode: ["MediaItem", "Page"],
    NodeWithAuthor: ["MediaItem", "Page", "Person", "Post", "Project"],
    NodeWithComments: ["MediaItem", "Page", "Post"],
    NodeWithTemplate: ["MediaItem", "Page", "Person", "Post", "Project"],
    NodeWithTitle: ["MediaItem", "Page", "Person", "Post", "Project"],
    MenuItemObjectUnion: ["Category", "Page", "Post", "ProjectType", "Tag"],
...
export interface ContentNode {
  __typename?: "MediaItem" | "Page" | "Person" | "Post" | "Project";
  conditionalTags?: Maybe<ConditionalTags>;
  /**
 ...
 */
export interface DeleteProjectTypePayload {
...
export interface MenuItemLinkable {
  __typename?: "Category" | "Page" | "Post" | "ProjectType" | "Tag";
  /**
   * The unique resource identifier path
   */
  databaseId: ScalarsEnums["Int"];
 ...
 * Connection between the person type and the person type
 */
export interface PersonToPreviewConnectionEdge {
...
export interface Project {
   ...
   */
  authorId?: Maybe<ScalarsEnums["ID"]>;
  clientName?: Maybe<ScalarsEnums["String"]>;
  conditionalTags?: Maybe<ConditionalTags>;
  /**
   * Connection between the ContentNode type and the ContentType type
   */
   ...
   */
  dueDate?: Maybe<ScalarsEnums["String"]>;
  /**
   * If a user has edited the node within the past 15 seconds, this will return the user that last edited. Null if the edit lock doesn&#039;t exist or is greater than 15 seconds
   */
  editingLockedBy?: Maybe<ContentNodeToEditLockConnectionEdge>;
  ...
  modifiedGmt?: Maybe<ScalarsEnums["String"]>;
  /**
   * This is the name for the project
   */
  name?: Maybe<ScalarsEnums["String"]>;
  /**
  ...
  projectTypes: (args?: {
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<ProjectToProjectTypeConnectionWhereArgs>;
  }) => Maybe<ProjectToProjectTypeConnection>;
  /**
   * The uri slug for the post. This is equivalent to the WP_Post-&gt;post_name field and the post_name column in the database for the &quot;post_objects&quot; table.
   */
  slug?: Maybe<ScalarsEnums["String"]>;
  ...
  terms: (args?: {
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<ProjectToTermNodeConnectionWhereArgs>;
  }) => Maybe<ProjectToTermNodeConnection>;
  /**
   * The title of the post. This is currently just the raw title. An amendment to support rendered title needs to be made.
   */
  title: (args?: {
 ...
 * Connection between the project type and the projectType type
 */
export interface ProjectToProjectTypeConnection {
 ...
 * An edge in a connection
 */
export interface ProjectToProjectTypeConnectionEdge {
 ...
 * Connection between the project type and the TermNode type
 */
export interface ProjectToTermNodeConnection {
 ...
 * An edge in a connection
 */
export interface ProjectToTermNodeConnectionEdge {
...
export interface ProjectType {
  ...
  contentNodes: (args?: {
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<ProjectTypeToContentNodeConnectionWhereArgs>;
  }) => Maybe<ProjectTypeToContentNodeConnection>;
  /**
   * The number of objects connected to the object
   */
  count?: Maybe<ScalarsEnums["Int"]>;
   ...
   * @deprecated Deprecated in favor of databaseId
   */
  projectTypeId?: Maybe<ScalarsEnums["Int"]>;
  /**
  ...
  projects: (args?: {
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<ProjectTypeToProjectConnectionWhereArgs>;
  }) => Maybe<ProjectTypeToProjectConnection>;
  /**
   * An alphanumeric identifier for the object unique to its type.
   */
  slug?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the projectType type and the ContentNode type
 */
export interface ProjectTypeToContentNodeConnection {
 ...
 * An edge in a connection
 */
export interface ProjectTypeToContentNodeConnectionEdge {
 ...
 * Connection between the projectType type and the project type
 */
export interface ProjectTypeToProjectConnection {
 ...
 * An edge in a connection
 */
export interface ProjectTypeToProjectConnectionEdge {
 ...
 * Connection between the projectType type and the Taxonomy type
 */
export interface ProjectTypeToTaxonomyConnectionEdge {
 ...
 */
export interface RootQueryToPersonConnection {
  __typename?: "RootQueryToPersonConnection";
  /**
   * Edges for the RootQueryToPersonConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToPersonConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
 ...
 * An edge in a connection
 */
export interface RootQueryToPersonConnectionEdge {
 ...
 */
export interface RootQueryToProjectTypeConnection {
 ...
 * An edge in a connection
 */
export interface RootQueryToProjectTypeConnectionEdge {
...
export interface TermNode {
  __typename?: "Category" | "PostFormat" | "ProjectType" | "Tag";
  conditionalTags?: Maybe<ConditionalTags>;
  /**
   * The number of objects connected to the object
   */
...
export interface User {
  ...
  /**
   * Connection between the User type and the person type
   */
  people: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<UserToPersonConnectionWhereArgs>;
  }) => Maybe<UserToPersonConnection>;
  /**
 ...
 * Connection between the User type and the person type
 */
export interface UserToPersonConnection {
  __typename?: "UserToPersonConnection";
  /**
   * Edges for the UserToPersonConnection connection
   */
  edges?: Maybe<Array<Maybe<UserToPersonConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Person>>>;
 ...
 * An edge in a connection
 */
export interface UserToPersonConnectionEdge {
  __typename?: "UserToPersonConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
...
export interface Mutation {
  ...
  createProjectType: (args: {
    input: CreateProjectTypeInput;
  }) => Maybe<CreateProjectTypePayload>;
  ...
  deleteProjectType: (args: {
    input: DeleteProjectTypeInput;
  }) => Maybe<DeleteProjectTypePayload>;
  ...
  updateProjectType: (args: {
    input: UpdateProjectTypeInput;
  }) => Maybe<UpdateProjectTypePayload>;
  updateSettings: (args: {
...
export interface Query {
  ...
  people: (args?: {
    ...
    first?: Maybe<Scalars["Int"]>;
    last?: Maybe<Scalars["Int"]>;
    where?: Maybe<RootQueryToPersonConnectionWhereArgs>;
  }) => Maybe<RootQueryToPersonConnection>;
  person: (args: {
    asPreview?: Maybe<Scalars["Boolean"]>;
    id: Scalars["ID"];
    idType?: Maybe<PersonIdType>;
  }) => Maybe<Person>;
  personBy: (args?: {
    id?: Maybe<Scalars["ID"]>;
  ...
  projectType: (args: {
    id: Scalars["ID"];
    idType?: Maybe<ProjectTypeIdType>;
  }) => Maybe<ProjectType>;
  projectTypes: (args?: {
    after?: Maybe<Scalars["String"]>;
    before?: Maybe<Scalars["String"]>;
    first?: Maybe<Scalars["Int"]>;
    last?: Maybe<Scalars["Int"]>;
    where?: Maybe<RootQueryToProjectTypeConnectionWhereArgs>;
  }) => Maybe<RootQueryToProjectTypeConnection>;
  projects: (args?: {
    after?: Maybe<Scalars["String"]>;
    before?: Maybe<Scalars["String"]>;
    first?: Maybe<Scalars["Int"]>;
...
export interface SchemaObjectTypes {
  ...
  CreateProjectTypePayload: CreateProjectTypePayload;
  ...
  DeleteProjectTypePayload: DeleteProjectTypePayload;
  ...
  Person: Person;
  PersonToPreviewConnectionEdge: PersonToPreviewConnectionEdge;
  Plugin: Plugin;
  Post: Post;
  PostFormat: PostFormat;
  ...
  ProjectToProjectTypeConnection: ProjectToProjectTypeConnection;
  ProjectToProjectTypeConnectionEdge: ProjectToProjectTypeConnectionEdge;
  ProjectToTermNodeConnection: ProjectToTermNodeConnection;
  ProjectToTermNodeConnectionEdge: ProjectToTermNodeConnectionEdge;
  ProjectType: ProjectType;
  ProjectTypeToContentNodeConnection: ProjectTypeToContentNodeConnection;
  ProjectTypeToContentNodeConnectionEdge: ProjectTypeToContentNodeConnectionEdge;
  ProjectTypeToProjectConnection: ProjectTypeToProjectConnection;
  ProjectTypeToProjectConnectionEdge: ProjectTypeToProjectConnectionEdge;
  ProjectTypeToTaxonomyConnectionEdge: ProjectTypeToTaxonomyConnectionEdge;
  Query: Query;
  ...
  RootQueryToPersonConnection: RootQueryToPersonConnection;
  RootQueryToPersonConnectionEdge: RootQueryToPersonConnectionEdge;
  ...
  RootQueryToProjectTypeConnection: RootQueryToProjectTypeConnection;
  RootQueryToProjectTypeConnectionEdge: RootQueryToProjectTypeConnectionEdge;
  ...
  UpdateProjectTypePayload: UpdateProjectTypePayload;
  ...
  UserToPersonConnection: UserToPersonConnection;
  UserToPersonConnectionEdge: UserToPersonConnectionEdge;
...
export interface ScalarsEnums extends MakeNullable<Scalars> {
  ...
  ContentTypesOfProjectTypeEnum: ContentTypesOfProjectTypeEnum | undefined;
  ...
  PersonIdType: PersonIdType | undefined;
  ...
  ProjectTypeIdType: ProjectTypeIdType | undefined;
